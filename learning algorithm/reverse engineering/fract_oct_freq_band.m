...
% %
% % fract_oct_freq_band: Calculates the 1/nth octave band center, lower, and upper 
% % bandedge frequency limits
% % 
% % Syntax;    
% % 
% % [fexact_l_c_u, fnominal_l_c_u, fnominal_str_l_c_u] = ...
% % fract_oct_freq_band(N, min_f, max_f, SI_prefixes, base10, fr);
% % 
% % **********************************************************************
% % 
% % Description
