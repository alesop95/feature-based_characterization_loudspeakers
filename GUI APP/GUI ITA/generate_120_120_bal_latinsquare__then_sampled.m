...
% double quotes define a string array with size 1x1 (i.e. scalar, regardless of how many characters it has). 
% We can think of string arrays as a kind of container for character vectors.
% Example: 
% If we do C = cell(A) 
%  then size(C{1,1})
% ans =
...
%     '11'
%
% THIS DOES THE SAME THING (Ciccio == C in this example)
% Ciccio = convertStringsToChars(A)
%
% Ciccio =
%
%  15×120 cell array
...
save('lookuptable_string','A_sampled')
