...
handles.results = string(zeros(1,handles.tot_attr*handles.tot_speakers*handles.tot_tracks))  % 0s ARE BASICALLY MISSING VALUES!
...
% DIRECTLY GENERATE THE CELL ARRAY WITH LABELS AND PUT IN THE GUI STRUCTURE
    C = {["Too soft","|","Too loud"],["Dark","Neutral","Bright"],...            sprintf('%s\n%s', "Neither like", "nor dislike");
